...
<body>
    ...
    <div class="hero" style="background-image: url('../../Public/Images/basil_blurred.jpg'); background-size: cover; background-position: center; height: 600px; display: flex; align-items: center; justify-content: center; text-align: center; color: #fff;">
